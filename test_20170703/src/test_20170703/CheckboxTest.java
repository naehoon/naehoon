...
public class CheckboxTest {
	...
	public static void main(String[]args){
		...
		Label q1 = new Label("1. 당신의 관심분야는 무엇입니까(여러개 선택가능");
		...
		Checkbox movie1 = new Checkbox("한달에 한번갑니다", group1, true);
		Checkbox movie2 = new Checkbox("일주일에 한번갑니다", group1, false);
		Checkbox movie3 = new Checkbox("일주일에 두번갑니다", group1, false);
