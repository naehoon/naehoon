			...
			public void actionPerformed(ActionEvent e) {
				...
				if (e.getSource() == jb1) { // 등록하기 버튼 클릭했을때　　
					...
					try {
						...
						nbvo = new NoticeBoardVO(jt[1].getText() // 작성자　　// 作成者
								, jt[0].getText() // 제목　　// タイトル
								, jta.getText() // 내용　// 内容
								, qa); // 게시글 분류　// 書き込みを分類
						
						System.out.println("@@@@@@@@@@@@@@ 작성자 : " + nbvo.getWriter()); 
						System.out.println("@@@@@@@@@@@@@@ 제목: " + nbvo.getSubject());
						System.out.println("@@@@@@@@@@@@@@ 내용" + nbvo.getContent());
						System.out.println("@@@@@@@@@@@@@@ 버튼" + nbvo.getFlag());
						...
						} else if (jta.getText().equals(null)|| jta.getText().equals("")) {				
