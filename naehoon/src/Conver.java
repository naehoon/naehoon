...
public class Conver {
	...
	public static void main(String[]args){
		...
		System.out.println("변환할 단어를 입력하세요 (masu형으로)");
...
/*				char chng = (char)((int)tmpMasu.charAt(i)+1);
		...
		//2단 동사 
			...
			for(int i=0; i < inMasu.length(); i++){
				...
				if(inMasu.equals("します")){

					System.out.print("する\t"); //원형
					System.out.print("して\t"); //te 형
					System.out.print("しない\t"); //nai 형
					System.out.print("した\t"); //te 형
					System.out.print("できる\t"); //가능형
					System.out.print("しよう"); //의지형
					return;
					
				}else if(inMasu.equals("きます")){
					System.out.print("くる\t"); //원형
					System.out.print("きて\t"); //te 형
					System.out.print("こない\t"); //nai 형
					System.out.print("きた\t"); //te 형
					System.out.print("こられる\t"); //가능형
					System.out.print("こよう"); //의지형
					return;
				}
			}
		}
